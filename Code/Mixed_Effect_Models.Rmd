...
# Test significance of season differences 
dhglm_GC %>% emmeans(pairwise ~ Biol.Season, level=0.95)
glmm_GC %>% emmeans(pairwise ~ Biol.Season, level=0.95)

# Test significance of sex within each season
dhglm_GC %>% emmeans(pairwise ~ Sex | Biol.Season, level=0.9)
glmm_GC %>% emmeans(pairwise ~ Sex | Biol.Season, level=0.9)

# Test significance of breeding status
dhglm_GC %>% emmeans(pairwise ~ Breeder, level=0.95)
glmm_GC %>% emmeans(pairwise ~ Breeder, level=0.95)

# Function to extract percent change information from avg_comparisons
...
# Apply function to both dhglm_GC and glmm_GC
...
# Test significance of differences between seasons
dhglm_T3 %>% emmeans(pairwise ~ Biol.Season, level=0.95)
glmm_T3 %>% emmeans(pairwise ~ Biol.Season, level=0.95)

# Test significance of sex within each season
dhglm_T3 %>% emmeans(pairwise ~ Sex | Biol.Season, level=0.9)
glmm_T3 %>% emmeans(pairwise ~ Sex | Biol.Season, level=0.9)

# Test significance of breeding status
dhglm_T3 %>% emmeans(pairwise ~ Breeder, level=0.95)
glmm_T3 %>% emmeans(pairwise ~ Breeder, level=0.95)
...
# Test significance of differences between seasons
dhglm_T4 %>% emmeans(pairwise ~ Biol.Season, level=0.95)
glmm_T4 %>% emmeans(pairwise ~ Biol.Season, level=0.95)

# Test significance of sex within each season
dhglm_T4 %>% emmeans(pairwise ~ Sex | Biol.Season, level=0.9)
glmm_T4 %>% emmeans(pairwise ~ Sex | Biol.Season, level=0.9)

# Test significance of breeding status
dhglm_T4 %>% emmeans(pairwise ~ Breeder, level=0.95)
glmm_T4 %>% emmeans(pairwise ~ Breeder, level=0.95)
