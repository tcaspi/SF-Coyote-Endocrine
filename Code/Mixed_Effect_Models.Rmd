...
map(comparisons_list, ~ do.call(avg_comparisons, c(list(dhglm_GC, conf_level = 0.95), .x)))
map(comparisons_list, ~ do.call(avg_comparisons, c(list(glmm_GC, conf_level = 0.95), .x)))
...
```{r}
# Average marginal contrasts - change significance level as needed
map(comparisons_list, ~ do.call(avg_comparisons, c(list(dhglm_T3, conf_level = 0.95), .x)))
map(comparisons_list, ~ do.call(avg_comparisons, c(list(glmm_T3, conf_level = 0.95), .x)))
...
```{r}
# Average marginal contrasts - change significance level as needed
map(comparisons_list, ~ do.call(avg_comparisons, c(list(dhglm_T4, conf_level = 0.95), .x)))
map(comparisons_list, ~ do.call(avg_comparisons, c(list(glmm_T4, conf_level = 0.95), .x)))
